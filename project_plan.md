...
| # | Member | Role |
|---|--------|------|
| 4 | **Rahma Ebrahem** (Sub-Leader) | React, Vite, Component Architecture |
| 5 | **Omnia Helmy** | D3.js, Network Topology Graph |
| 6 | **AI** | Tailwind CSS, Dashboard UI, UX |
...
| 8 | **Mariz Ehap** | Wazuh (EDR), Elasticsearch, Kibana |
...
| 10 | **Yosef Ali & Mazin Alla ** | Testing (API, Integration, E2E) |
...
| **Omnia Helme ** | Frontend | Ensure UI consistency, review PRs, present frontend at final demo |
